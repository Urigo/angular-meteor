...
// Doing lexicographical comparison here isn't quite correct, but both
// "METEOR@1.1.0.3", "METEOR@1.1.1" and "METEOR@1.2" are greater than
// "METEOR@1.1.0.2" so this should work fine.
if (Meteor.release > "METEOR@1.1.0.2") {
  console.error("Please delete the `packages/spiderable` directory in this repository.");
  console.error();
  console.error("The version of spiderable that was released with the version of Meteor");
  console.error("that comes after 1.1.0.2 already contains the code that lets you configure");
