...
/** 
 * Compiler copied from 
 * https://github.com/meteor/meteor/blob/devel/packages/less/plugin/compile-less.js
 * except some minor changes.
 * Since less package registers a compiler, there is
 * no way to make use of the compiler other then copying.
 */
...
classMixin(LessCompiler, BasicCompiler);
