...
angularMeteorSubscribe.service('$meteorSubscribe', ['$q',
  function ($q) {
    ...
    this._subscribe = function(scope, deferred, args) {
      ...
      console.warn('[angular-meteor.subscribe] Please note that this module is deprecated since 1.3.0 and will be removed in 1.4.0! http://info.meteor.com/blog/angular-meteor-1.3');
