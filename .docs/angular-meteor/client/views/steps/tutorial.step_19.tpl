  <div>
    ...
    <div class="col-md-8">
      <h1>Step 19 - 3rdParty Libraries</h1>
    </div>
...
Many parts of this tutorial also relevant for users who uses only Meteor, without angular-meteor, because the solution for third-party libraries comes from Meteor packaging manager - **Atmosphere**.
