...
* When you navigate to `index.html`, you will be redirected to `index.html/parties` and the party list should appear in the browser.
...
Now we can delete the `index.html` file, it's not used any more.
...
If that's the case, double check your paths and remember to use the file extension `.html`.
