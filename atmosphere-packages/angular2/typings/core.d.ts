...
declare module 'angular2/core' {
    ...
    export { APP_ID, APP_COMPONENT, APP_INITIALIZER, PACKAGE_ROOT_URL, PLATFORM_INITIALIZER } from 'angular2/core/src/core/application_tokens';
...
declare module 'angular2/core/src/core/metadata' {
    /**
        ...
        */
    export { QueryMetadata, ContentChildrenMetadata, ContentChildMetadata, ViewChildrenMetadata, ViewQueryMetadata, ViewChildMetadata, AttributeMetadata } from 'angular2/core/src/core/metadata/di';
    export { ComponentMetadata, DirectiveMetadata, PipeMetadata, InputMetadata, OutputMetadata, HostBindingMetadata, HostListenerMetadata } from 'angular2/core/src/core/metadata/directives';
    export { ViewMetadata, ViewEncapsulation } from 'angular2/core/src/core/metadata/view';
    import { QueryMetadata, ContentChildrenMetadata, ViewChildrenMetadata, AttributeMetadata } from 'angular2/core/src/core/metadata/di';
...
declare module 'angular2/core/src/core/di' {
    /**
      ...
      */
    export { InjectMetadata, OptionalMetadata, InjectableMetadata, SelfMetadata, HostMetadata, SkipSelfMetadata, DependencyMetadata } from 'angular2/core/src/core/di/metadata';
    ...
    export { Binding, ProviderBuilder, ResolvedBinding, ResolvedFactory, Dependency, bind, Provider, ResolvedProvider, provide } from 'angular2/core/src/core/di/provider';
    export { Key } from 'angular2/core/src/core/di/key';
    export { NoProviderError, AbstractProviderError, CyclicDependencyError, InstantiationError, InvalidProviderError, NoAnnotationError, OutOfBoundsError } from 'angular2/core/src/core/di/exceptions';
...
declare module 'angular2/core/src/core/linker' {
    export { AfterContentInit, AfterContentChecked, AfterViewInit, AfterViewChecked, OnChanges, OnDestroy, OnInit, DoCheck } from 'angular2/core/src/core/linker/interfaces';
...
declare module 'angular2/core/src/core/di/decorators' {
    import { InjectMetadata, OptionalMetadata, InjectableMetadata, SelfMetadata, HostMetadata, SkipSelfMetadata } from 'angular2/core/src/core/di/metadata';
    /**
...
declare module 'angular2/core/src/core/change_detection/change_detection' {
    import { IterableDiffers, IterableDifferFactory } from 'angular2/core/src/core/change_detection/differs/iterable_differs';
    import { KeyValueDiffers, KeyValueDifferFactory } from 'angular2/core/src/core/change_detection/differs/keyvalue_differs';
    export { DefaultKeyValueDifferFactory, KeyValueChangeRecord } from 'angular2/core/src/core/change_detection/differs/default_keyvalue_differ';
    export { DefaultIterableDifferFactory, CollectionChangeRecord } from 'angular2/core/src/core/change_detection/differs/default_iterable_differ';
    export { ASTWithSource, AST, AstTransformer, PropertyRead, LiteralArray, ImplicitReceiver } from 'angular2/core/src/core/change_detection/parser/ast';
    ...
    export { DehydratedException, ExpressionChangedAfterItHasBeenCheckedException, ChangeDetectionError } from 'angular2/core/src/core/change_detection/exceptions';
    export { ProtoChangeDetector, ChangeDetector, ChangeDispatcher, ChangeDetectorDefinition, DebugContext, ChangeDetectorGenConfig } from 'angular2/core/src/core/change_detection/interfaces';
    export { ChangeDetectionStrategy, CHANGE_DETECTION_STRATEGY_VALUES } from 'angular2/core/src/core/change_detection/constants';
    ...
    export { IterableDiffers, IterableDiffer, IterableDifferFactory, TrackByFn } from 'angular2/core/src/core/change_detection/differs/iterable_differs';
    export { KeyValueDiffers, KeyValueDiffer, KeyValueDifferFactory } from 'angular2/core/src/core/change_detection/differs/keyvalue_differs';
...
declare module 'angular2/core/src/core/change_detection/differs/default_keyvalue_differ' {
    import { ChangeDetectorRef } from 'angular2/core/src/core/change_detection/change_detector_ref';
    import { KeyValueDiffer, KeyValueDifferFactory } from 'angular2/core/src/core/change_detection/differs/keyvalue_differs';
...
declare module 'angular2/core/src/core/change_detection/differs/default_iterable_differ' {
    import { ChangeDetectorRef } from 'angular2/core/src/core/change_detection/change_detector_ref';
    import { IterableDiffer, IterableDifferFactory, TrackByFn } from 'angular2/core/src/core/change_detection/differs/iterable_differs';
...
declare module 'angular2/core/src/core/change_detection/parser/parser' {
    ...
    import { AST, BindingPipe, LiteralMap, TemplateBinding, ASTWithSource } from 'angular2/core/src/core/change_detection/parser/ast';
    export class Parser {
...
declare module 'angular2/core/src/core/change_detection/proto_change_detector' {
    import { ChangeDetector, ProtoChangeDetector, ChangeDetectorDefinition } from 'angular2/core/src/core/change_detection/interfaces';
...
declare module 'angular2/core/src/core/change_detection/jit_proto_change_detector' {
    import { ProtoChangeDetector, ChangeDetector, ChangeDetectorDefinition } from 'angular2/core/src/core/change_detection/interfaces';
