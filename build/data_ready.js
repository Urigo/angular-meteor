...
var DataReadyHelper = (function () {
    function DataReadyHelper() {
    }
    DataReadyHelper.pushCb = function (callbacks) {
        var _this = this;
    ...
    DataReadyHelper.onAll = function (resolve) {
        Promise.all(this._promises).then(resolve);
    };
    DataReadyHelper.len = function () {
        return this._promises.length;
    };
    DataReadyHelper._promises = [];
    return DataReadyHelper;
}());
exports.DataReadyHelper = DataReadyHelper;
